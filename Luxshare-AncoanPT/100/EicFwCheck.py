...
class EicFwCheck(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AncoanPT/100/Config","file": "UUT.yaml", "name": "Eic", "key": "tools/ancoan/Eic"},
            {"folder": "Luxshare-AncoanPT/100/Config","file": "UUT.yaml", "name": "Eic_info", "key": "tools.ancoan.Eic"},
