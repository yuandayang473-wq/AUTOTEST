...
class InitTestEnvironment(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            {"folder": "Luxshare-AncoanPT/100/Config", "file": "UUT.yaml", "name": "InitPath", "key": "tools/ancoan/rpm"}
        ]
    ...
    def exe(self):
        ...
        self.os_run.run(f"chmod  -R +777 {self.root_path}/tools/ancoan/fw")
        self.os_run.run(f"chmod  -R +777 {self.root_path}/tools/ancoan/fru")
