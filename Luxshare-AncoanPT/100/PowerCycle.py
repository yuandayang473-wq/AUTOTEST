...
class PowerCycle(BaseConfigCheck):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AncoanPT/100/Config", "file": "UUT.yaml", "name": "cfg", "key": self.parent.globals["RK"]},
            {"folder": "Luxshare-AncoanPT/100/Config", "file": "UUT.yaml", "name": "path", "key": "InitPath"},
            {"folder": "Luxshare-AncoanPT/100/Config", "file": "UUT.yaml", "name": "oam_conf", "key": "OAM"},
            {"folder": "Luxshare-AncoanPT/100/Config", "file": "UUT.yaml", "name": "lspcipath", "key": "Lspci"},
