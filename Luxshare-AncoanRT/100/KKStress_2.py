...
class KKStress_2(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AncoanRT/100/Config", "file": "UUT.yaml", "name": "kingkong_path",
             "key": "tools/ancoan/kingkong"},
            {"folder": "Luxshare-AncoanRT/100/Config", "file": "UUT.yaml", "name": "kingkong_info",
             "key": "tools.ancoan.kingkong"},
            {"folder": "Luxshare-AncoanRT/100/Config", "file": "UUT.yaml", "name": "rpm", "key": "tools/ancoan/rpm"},
            {"folder": "Luxshare-AncoanRT/100/Config", "file": "UUT.yaml", "name": "rpm_info",
    ...
    def init_env(self):
        ...
        self.os_run.run(f"cd {path};wget -t 5 -T 60 -r -np -nH -R index.html {_kingkong}")
    ...
    def exe(self):
        ...
        self.os_run.run(cat_kk_cmd, save_exit_code=True)
