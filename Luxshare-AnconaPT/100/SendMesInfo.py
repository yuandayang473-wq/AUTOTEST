...
class SendMesInfo(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaPT/100/Config", "file": "UUT.yaml", "name": "Iperf", "key": "Iperf"},{"file": "BmcDevice.yaml", "name": "JBMC", "key":"BMC_02"},
        ]
    ...
    def exe(self):
        ...
        with self.ssh_connect(uut=self.config["UUT"]):
            ...
            _server_sn =  _mes.get_mes_info(self.mes_info["info"]["sn"])["Results"]["server_sn"]
            _server_tdid =  _mes.get_mes_info(self.mes_info["info"]["sn"])["Results"]["server_tdid"]
