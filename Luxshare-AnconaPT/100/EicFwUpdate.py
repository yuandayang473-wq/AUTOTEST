...
class EicFwUpdate(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaPT/100/Config","file": "UUT.yaml", "name": "Eic", "key": "tools/ancoan/Eic"},
            {"folder": "Luxshare-AnconaPT/100/Config","file": "UUT.yaml", "name": "Eic_info", "key": "tools.ancoan.Eic"},
    ...
    def exe(self):
        ...
        for ver in rst:
            ...
            if ver != eic_ver:
                self.os_run.run(f"cd  {name}/02-DevelopKit/01-Package/platform/ && ./platform_test.sh mt 7 -a work -f files/{eicupdatefile} ")
                break
        self.os_run.run(f"cd  {name}/02-DevelopKit/01-Package/platform/ && ./platform_test.sh mt 7 -a work -r ")
