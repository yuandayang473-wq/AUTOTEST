...
class NicFwCheck(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaPT/100/Config", "file": "FwVersion.yaml", "name": "DeviceCount", "key": "DEVICE_COUNT"},
            # {"folder": "Luxshare-AnconaPT/100/Config", "file": "UUT.yaml", "name": "cfg", "key": options.RK},
        ]
