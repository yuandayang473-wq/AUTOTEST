...
class HibChassisExtra(TempItem):
    ...
    def exe(self):
        with self.ssh_connect(uut=self.config["UUT"]):
            ...
            write_info =  _mes.get_mes_info(self.mes_info["info"]["sn"])["Results"]["jbog_customer_part_number"]
            ...
            self.assertEqual(ErrorCode.FFFFFFFF, f" Hib Chassis board Extra ", write_info, parser)
