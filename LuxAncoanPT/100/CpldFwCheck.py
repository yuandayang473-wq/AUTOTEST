...
class CpldFwCheck(TempItem):
    ...
    def exe(self):
        ...
        with self.ssh_connect(uut=self.config["BMC_HEADER"]):
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check cpuboars cpld fw version", current_header_cpldver, FwVsersion.get("cpuboard_ver"))
            self.logger.info("======================================================================")

            self.logger.info("========================check cmu fw version===========================")
            parser = self.execute_run("ipmitool alioem version | grep -iw -A1 cmu | tail -n1")
            current_header_cpldver = re.search(r'\d+.\d+', parser.get_origin_data()).group().strip()
            self.assertEqual(ErrorCode.FWTCH003, "check header cpld fw version", current_header_cpldver, FwVsersion.get("cmuboard_ver"))
            self.logger.info("======================================================================")
        ...
        with self.ssh_connect(uut=self.config["BMC_TAIL"]):
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check hib cpld fw version", parser.get_origin_data().strip(), FwVsersion.get("hib_ver"))
            self.logger.info("======================================================================")
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check ubb1 cpld fw version", parser.get_origin_data().strip(), FwVsersion.get("ubb1"))
            self.logger.info("======================================================================")
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check ubb2 cpld fw version", parser.get_origin_data().strip(), FwVsersion.get("ubb2"))
            self.logger.info("======================================================================")
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check fanbp fw version", parser.get_origin_data().strip(), FwVsersion.get("fanbp80"))
            self.logger.info("======================================================================")
            ...
            if m_config == "W scaleout":
                ...
                self.assertEqual(ErrorCode.FWTCH003, "check 40fanbp fw version", parser.get_origin_data().strip(), FwVsersion.get("fanbp40"))
                self.logger.info("======================================================================")
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check nvmebp1 fw version", parser.get_origin_data().strip(), FwVsersion.get("nvmebp1"))
            self.logger.info("======================================================================")
            ...
            self.assertEqual(ErrorCode.FWTCH003, "check nvmebp2 fw version", parser.get_origin_data().strip(), FwVsersion.get("nvmebp2"))
            self.logger.info("======================================================================")
