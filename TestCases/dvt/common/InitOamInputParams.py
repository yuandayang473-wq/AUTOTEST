...
class InitOamInputParams(TempItem):
    ...
    def init_get_params(self):
        ...
        # 获取sn
        sn = input(self.tip.format("UBB SN: "))
        pattern = r"^\w+$"
        result = re.match(pattern, sn)
        if not result:
            fail_sn_msg = "UBB SN: " + sn + "格式有误!"
...
if __name__ == '__main__':
    runner.single_runner(InitOamInputParams)
