...
from TestCases.dvt.rt.BaseConfigCheck import BaseConfigCheck
...
class PowerCycle(BaseConfigCheck):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"file": "PduDevice.yaml", "name": "pdu", "key": self.locals["PDU"]},{"file": "BmcDevice.yaml", "name": "JBMC", "key":self.locals["TAIL_TAOBAO_BMC"]},
            ...
            {"file": "UUT.yaml", "name": "lspcipath", "key": "Lspci"},
    ...
    def power_cycle_ac(self):
        ...
        with self.ssh_connect(uut=user):
            ...
            self.logger.info("sleep time 30 ")
            time.sleep(30)
