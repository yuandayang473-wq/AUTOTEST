...
class HibCpldFwUpdate(TempItem):
    ...
    def exe(self):
        ...
        self.logger.info("========================Get tail HIB version===========================")
        ...
        with self.ssh_connect(uut=self.config["UUT"]):
            ...
            if current_versions['hib_ver'] != FwVsersion.get("hib_ver"):
                ...
                self.execute_run(f"{path['hib_cpld_script']} {tail_bmc_ip} admin admin {path['hib_cpld_fw']}",
...
if __name__ == '__main__':
    runner.single_runner(HibCpldFwUpdate)
