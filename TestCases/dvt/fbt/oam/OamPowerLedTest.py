...
class OamPowerLedTest(TempItem):

    def __init__(self):
        super().__init__()
        self.name = "oam led"
        self.expect = "This is oam led function check test"
    ...
    def exe(self):
        ...
        self.sleep(2)
        tips = self.tips_msg("请查看OAM电源灯! (Y/y: 电源灯常亮绿色, N/n: 电源灯灭)")
        self.logger.info(tips)

        print(tips)
        select_tips = self.tips_msg("请输入选择字母[Y/y N/n]: ")
        ...
        return Fail(self, ErrItemFail("OAM电源灯检查失败"))


if __name__ == '__main__':
    runner.single_runner(OamPowerLedTest)
