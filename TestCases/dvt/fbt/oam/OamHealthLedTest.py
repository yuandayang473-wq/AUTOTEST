...
class OamHealthLedTest(TempItem):
    ...
    def exe(self):
        ...
        self.sleep(2)
        tips = self.tips_msg("请查看OAM健康灯! (G/g: 健康灯Pass, R/r: 健康灯Fail)")
        ...
        return Fail(self, ErrItemFail("OAM健康灯检查失败"))


if __name__ == '__main__':
    runner.single_runner(OamHealthLedTest)
