...
class BaseConfigCheck(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "oam_conf", "key": "OAM"},
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "fw", "key": "tools/ancoan/fw"},
        ]
    ...
    def nvme(self):
        ...
        parser = self.os_run.run(f"{self.config['fw']['nvmefw']['tool']} list")
    ...
    def ssd(self):
        ...
        with self.action("ssd"):
            ...
            # parser = self.os_run.run(disk_type_cmd)
            # lines = parser.split("\n")
            # m2_data = []
            # for line in lines:
            #     if line:
