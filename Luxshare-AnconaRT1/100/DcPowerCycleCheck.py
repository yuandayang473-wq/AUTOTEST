...
class DcPowerCycleCheck(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "InitPath", "key": "InitPath"},
            {"file": "Device.yaml", "name": "UUT", "key":"UUT_01"},
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "kkpath", "key": "tools/ancoan/kingkong"},
    ...
    def check_busid(self):
        ...
        json_file = f"{work_path}/Luxshare-AnconaRT1/100/Config/lspci_json_files/{rk_num}_lspci.json"
        lspci_tool = f'{work_path}/Luxshare-AnconaRT1/100/create_lspci_dict.py'
        with self.ssh_connect(uut=self.config["UUT"]):
