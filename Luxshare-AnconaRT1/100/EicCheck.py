...
class EicCheck(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "Iperf", "key": "Iperf"},
            {"file": "BmcDevice.yaml", "name": "JBMC", "key": "BMC_01"},
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "cfg", "key": self.mes_info["info"]["rk"]},
        ]
    ...
    def exe(self):
        ...
        with self.ssh_connect(uut=self.config["UUT"]):     
            self.execute_run(f"tar -xvf /run/LuxScript/tools/ancoan/Eic/EIC1.0_platfrom_v.1.1.4.2_230731.tar.gz -C /root/")
