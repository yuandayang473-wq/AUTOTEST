...
filter_id = ["0000:08:00.0", "0000:7e:00.0", "0000:a2:00.0", "0000:c6:00.0", "0001:10:00.0", "0001:86:00.0", "0001:aa:00.0", "0001:ce:00.0"]
...
for info in output:
    ...
    if cesta:
        if id  in filter_id:
            dict_info["cesta"] = "RxErr- BadTLP- BadDLLP- Rollover- Timeout- AdvNonFatalErr-"
        else:
