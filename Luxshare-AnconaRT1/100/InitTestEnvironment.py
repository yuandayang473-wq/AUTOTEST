...
class InitTestEnvironment(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            {"folder": "Luxshare-AnconaRT1/100/Config", "file": "UUT.yaml", "name": "InitPath", "key": "tools/ancoan/rpm"}
        ]
