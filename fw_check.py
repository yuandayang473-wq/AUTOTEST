...
def check_aer(bdf):
    ...
    res = CESta.split()
    for value in res:
        if value == "CESta:" or value.startswith("AdvNonFatalErr") or value.startswith("RxErr"):
            continue
        res = value[-1]
        if res == '+':
        ...
        for idx, sw in enumerate(all_sw):
            ...
            if eps_arr:
                ...
                for ep in eps_arr:
                    ...
                    if dsp_sta_speed == "16GT/s" and dsp_cap_speed:
                        print(
                    ...
                    if dsp_sta_width == "x8" and dsp_cap_width:
                        print(
