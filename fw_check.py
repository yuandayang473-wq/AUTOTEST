...
def get_bdf():
    ...
    :return sw_bdf = [{'usp': xxx, 
            ...
            {'usp': xxx, 'eps':[{},{}...],...}]
            [{'usp': '01:00.0', 'eps': [{'dsp': '02:02.0', 'ep': '05:00.0', 'driver': 'mlx5_core', 'name': 'NA'}], 'mep': {'dsp': '02:1c.0', 'ep': '09:00.0', 'driver': 'nvme', 'name': 'NA'}, 'dma': [{'dsp': '02:1d.0', 'ep': '0a:00.0', 'driver': '', 'name': 'NA'}, {'dsp': '02:1e.0', 'ep': '0b:00.0', 'driver': '', 'name': 'NA'}], 'ntb': {}}]
    """
    # 读取vendor.yml
    ...
    for key,value in dict_all.items():
        ...
        for partition in sw:
            ...
            all_sudu_sw[key].append({'usp': partition[0], 'eps': ep_list,'mep': mep_dict, 'dma': dma_arr, 'ntb': ntb_dict})
...
def get_speed(bdf):
    cap_speed = execute_command(f"lspci -vvs {bdf} |grep LnkCap: |grep -i Speed|awk -F ' ' '{{print$5}}' |awk -F ',' '{{print$1}}'")
    sta_speed = execute_command(f"lspci -vvs {bdf} |grep LnkSta: |grep -i Speed|awk -F ' ' '{{print$3}}'")
    return cap_speed, sta_speed

def get_width(bdf):
    cap_width = execute_command(f"lspci -vvs {bdf} |grep LnkCap: |grep -i Width|awk -F ' ' '{{print$7}}' |awk -F ',' '{{print$1}}'")
...
if __name__ == '__main__':
    ...
    if all_sw:
        for idx, sw in enumerate(all_sw):
            ...
            usp_up_port = execute_command(f"lshw -class bridge -businfo |grep {usp_bdf} -B1 |head -n 1 |awk -F ' ' '{{print$1}}' |awk -F '@' '{{print$2}}'")
            ...
            if usp_sta_speed == usp_cap_speed and usp_cap_speed:
                print(f"\033[33mUsp Speed\033[0m: usp_cap_speed=usp_sta_speed={usp_sta_speed} *** [\033[32mPASS\033[0m]")
            else:
                print(f"\033[33mUsp Speed\033[0m: usp_cap_speed={usp_cap_speed} usp_sta_speed={usp_sta_speed} *** [\033[31mFAIL\033[0m]")

            usp_cap_width, usp_sta_width = get_width(usp_bdf)
            if usp_sta_width == usp_cap_width and usp_cap_width:
                print(f"\033[33mUsp Width\033[0m: usp_cap_width=usp_sta_width={usp_sta_width} *** [\033[32mPASS\033[0m]\n")
            else:
                print(f"\033[33mUsp Width\033[0m: usp_cap_width={usp_cap_width} usp_sta_width={usp_sta_width} *** [\033[31mFAIL\033[0m]\n")
            ...
            if mep_dict:
                ...
                if mep_idsp_sta_speed == mep_idsp_cap_speed and mep_idsp_cap_speed:
                    print(f"\033[33mMep iDSP Speed\033[0m: mep_idsp_cap_speed=mep_idsp_sta_speed={mep_idsp_sta_speed} *** [\033[32mPASS\033[0m]")
                else:
                    print(f"\033[33mMep iDSP Speed\033[0m: mep_idsp_cap_speed={mep_idsp_cap_speed} mep_idsp_sta_speed={mep_idsp_sta_speed} *** [\033[31mFAIL\033[0m]")
                ...
                if mep_idsp_sta_width == mep_idsp_cap_width and mep_idsp_cap_width:
                    print(f"\033[33mMep iDSP Width\033[0m: mep_idsp_cap_width=mep_idsp_sta_width={mep_idsp_sta_width} *** [\033[32mPASS\033[0m]\n")
                else:
                    print(f"\033[33mMep iDSP Width\033[0m: mep_idsp_cap_width={mep_idsp_cap_width} mep_idsp_sta_width={mep_idsp_sta_width} *** [\033[31mFAIL\033[0m]\n")
                ...
                if mep_sta_speed == mep_cap_speed and mep_cap_speed:
                    print(f"\033[33mMep iEP Speed\033[0m: mep_cap_speed=mep_sta_speed={mep_sta_speed} *** [\033[32mPASS\033[0m]")
                else:
                    print(f"\033[33mMep iEP Speed\033[0m: mep_cap_speed={mep_cap_speed} mep_sta_speed={mep_sta_speed} *** [\033[31mFAIL\033[0m]")
                mep_cap_width, mep_sta_width = get_width(mep)
                if mep_sta_width == mep_cap_width and mep_cap_width:
                    print(f"\033[33mMep iEP Width\033[0m: mep_cap_width=mep_sta_width={mep_sta_width} *** [\033[32mPASS\033[0m]")
                else:
                    print(f"\033[33mMep iEP Width\033[0m: mep_cap_width={mep_cap_width} mep_sta_width={mep_sta_width} *** [\033[31mFAIL\033[0m]")
            ...
            if ntb_dict:
                ...
                if ntb_idsp_sta_speed == ntb_idsp_cap_speed and ntb_idsp_cap_speed:
                    print(f"\033[33mNTB iDSP Speed\033[0m: ntb_idsp_cap_speed=ntb_idsp_sta_speed={ntb_idsp_sta_speed} *** [\033[32mPASS\033[0m]")
                else:
                    print(f"\033[33mNTB iDSP Speed\033[0m: ntb_idsp_cap_speed={ntb_idsp_cap_speed} ntb_idsp_sta_speed={ntb_idsp_sta_speed} *** [\033[31mFAIL\033[0m]")
                ...
                if ntb_idsp_sta_width == ntb_idsp_cap_width and ntb_idsp_cap_width:
                    print(f"\033[33mNTB iDSP Width\033[0m: ntb_idsp_cap_width=ntb_idsp_sta_width={ntb_idsp_sta_width} *** [\033[32mPASS\033[0m]\n")
                else:
                    print(f"\033[33mNTB iDSP Width\033[0m: ntb_idsp_cap_width={ntb_idsp_cap_width} ntb_idsp_sta_width={ntb_idsp_sta_width} *** [\033[31mFAIL\033[0m]\n")
                ...
                if ntb_sta_speed == ntb_cap_speed and ntb_cap_speed:
                    print(f"\033[33mNTB iEP Speed\033[0m: ntb_cap_speed=ntb_sta_speed={ntb_sta_speed} *** [\033[32mPASS\033[0m]")
                else:
                    print(f"\033[33mNTB iEP Speed\033[0m: ntb_cap_speed={ntb_cap_speed} ntb_sta_speed={ntb_sta_speed} *** [\033[31mFAIL\033[0m]")
                ntb_cap_width, ntb_sta_width = get_width(ntb)
                if ntb_sta_width == ntb_cap_width and ntb_cap_width:
                    print(f"\033[33mNTB iEP Width\033[0m: ntb_cap_width=ntb_sta_width={ntb_sta_width} *** [\033[32mPASS\033[0m]\n")
                else:
                    print(f"\033[33mNTB iEP Width\033[0m: ntb_cap_width={ntb_cap_width} ntb_sta_width={ntb_sta_width} *** [\033[31mFAIL\033[0m]\n")
            else:
            ...
            if dma_arr:
                ...
                for dma in dma_arr:
                    ...
                    if dma_idsp_sta_speed == dma_idsp_cap_speed and dma_idsp_cap_speed:
                        print(f"\033[33mDMA iDSP Speed\033[0m: dma_idsp_cap_speed=dma_idsp_sta_speed={dma_idsp_sta_speed} *** [\033[32mPASS\033[0m]")
                    else:
                        print(f"\033[33mDMA iDSP Speed\033[0m: dma_idsp_cap_speed={dma_idsp_cap_speed} dma_idsp_sta_speed={dma_idsp_sta_speed} *** [\033[31mFAIL\033[0m]")
                    dma_idsp_cap_width, dma_idsp_sta_width = get_width(dma_idsp)
                    if dma_idsp_sta_width == dma_idsp_cap_width and dma_idsp_cap_width:
                        print(f"\033[33mDMA iDSP Width\033[0m: dma_idsp_cap_width=dma_idsp_sta_width={dma_idsp_sta_width} *** [\033[32mPASS\033[0m]\n")
                    else:
                        print(f"\033[33mDMA iDSP Width\033[0m: dma_idsp_cap_width={dma_idsp_cap_width} dma_idsp_sta_width={dma_idsp_sta_width} *** [\033[31mFAIL\033[0m]\n")
                ...
                for dma in dma_arr:
                    ...
                    if dma_sta_speed == dma_cap_speed and dma_cap_speed:
                        print(f"\033[33mDMA iEP Speed\033[0m: dma_cap_speed=dma_sta_speed={dma_sta_speed} *** [\033[32mPASS\033[0m]")
                    else:
                        print(f"\033[33mDMA iEP Speed\033[0m: dma_cap_speed={dma_cap_speed} dma_sta_speed={dma_sta_speed} *** [\033[31mFAIL\033[0m]")
                    dma_cap_width, dma_sta_width = get_width(dma)
                    if dma_sta_width == dma_cap_width and dma_cap_width:
                        print(f"\033[33mDMA iEP Width\033[0m: dma_cap_width=dma_sta_width={dma_sta_width} *** [\033[32mPASS\033[0m]\n")
                    else:
                        print(f"\033[33mDMA iEP Width\033[0m: dma_cap_width={dma_cap_width} dma_sta_width={dma_sta_width} *** [\033[31mFAIL\033[0m]\n")
            else:
            ...
            if eps_arr:
                ...
                for ep in eps_arr:
                    ...
                    if dsp_sta_speed == dsp_cap_speed and dsp_cap_speed:
                        print(f"\033[33mDSP Speed\033[0m: dsp_cap_speed=dsp_sta_speed={dsp_sta_speed} *** [\033[32mPASS\033[0m]")
                    else:
                        print(f"\033[33mDSP Speed\033[0m: dsp_cap_speed={dsp_cap_speed} dsp_sta_speed={dsp_sta_speed} *** [\033[31mFAIL\033[0m]")
                    dsp_cap_width, dsp_sta_width = get_width(dsp)
                    if dsp_sta_width == dsp_cap_width and dsp_cap_width:
                        print(f"\033[33mDSP Width\033[0m: dsp_cap_width=dsp_sta_width={dsp_sta_width} *** [\033[32mPASS\033[0m]\n")
                    else:
                        print(f"\033[33mDSP Width\033[0m: dsp_cap_width={dsp_cap_width} dsp_sta_width={dsp_sta_width} *** [\033[31mFAIL\033[0m]\n")
