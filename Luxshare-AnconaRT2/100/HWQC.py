...
class HWQC(TempItem):
    ...
    def __init__(self):
        ...
        self.config = [
            ...
            {"folder": "Luxshare-AnconaRT2/100/Config", "file": "UUT.yaml", "name": "rpm", "key": "tools/ancoan/rpm"},
            {"folder": "Luxshare-AnconaRT2/100/Config", "file": "UUT.yaml", "name": "rpm_info", "key": "tools.ancoan.rpm"},
